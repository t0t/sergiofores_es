...
<div class="About">
    <div class="Bio">
        ...
        <p>
          <strong>Sergio Forés Raga</strong> es formado en Bellas Artes, Arte Electrónico y Diseño Digital. Ha ejercido desde 1999 como Diseñador gráfico y web. Desde 2010 especializado en Prototipado Frontend y UID. En 2020 adopta el mundo de la impresión 3D en su proceso creativo. También desarrolla una hermenéutica holística de la Creación como via de autoconocimiento que denomina TODH, Función TOT o +0+1234.<br><br>
          <small>Comparte habitualmente en sus perfiles de estas redes sociales:</small>
        </p>
    </div>
